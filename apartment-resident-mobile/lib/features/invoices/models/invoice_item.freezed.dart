...
abstract class $InvoiceItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String feeType, String description, int amount});
}
...
class _$InvoiceItemModelImpl implements _InvoiceItemModel {
  ...
  @override
  String toString() {
    return 'InvoiceItemModel(id: $id, feeType: $feeType, description: $description, amount: $amount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, feeType, description, amount);
  ...
  Map<String, dynamic> toJson() {
    return _$$InvoiceItemModelImplToJson(this);
  }
}
