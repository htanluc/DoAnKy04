...
public class AdminApartmentController {
    ...
    public ResponseEntity<List<VehicleDto>> getApartmentVehicles(@PathVariable Long id) {
        try {
            List<VehicleDto> vehicles = vehicleService.getVehiclesByApartmentId(id);
    ...
    /**
     * Get water meter readings for apartment (admin only)
    ...
    public ResponseEntity<List<ApartmentResidentDto>> getApartmentResidents(@PathVariable Long id) {
        try {
            List<ApartmentResidentDto> residents = apartmentResidentService.getApartmentResidentsByApartmentId(id);
